    ...
    public String registerUser(User user, Model model) {
        ...
        if(checkPasswordCriteria(user.getPassword())) {
           ...
           /* model.addAttribute("username",user.getUsername());
            model.addAttribute("fullname",user.getProfile().getFullName());
            model.addAttribute("emailaddress",user.getProfile().getEmailAddress());
            model.addAttribute("mobilenumber",user.getProfile().getMobileNumber()); */
            model.addAttribute("User",user);
            return "users/registration";
        }
    }
